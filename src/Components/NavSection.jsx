...
const NavSection = () => {
    ...
    //function to close menu when nav linknis click
    const HandleClose = () => {
        setIsOpen(false);

    }
  return (
    <nav className='bg-gray-200 shadow-md fixed w-full top-0 left-0 z-50'>
            ...
            isOpen && (
                <div className='md:hidden bg-white shadow-inner transition-all duration-300 ease-in-out overflow-hidden '>
                    <ul className='space-y-4 text-gray-700 font-medium'>
                        <li><Link to='/' onClick={HandleClose} className='hover:text-blue-500'>Home</Link></li>
                        <li> <Link to='aboutUs' onClick={HandleClose} className='hover:text-blue-500'>About Us</Link></li>
                        <li> <Link to='service' onClick={HandleClose} className='hover:text-blue-500'>Our Services</Link></li>
                        <li> <Link to='Booking' onClick={HandleClose} className='hover:text-blue-500'>Booking</Link></li>
                        <li> <Link to='Contact' onClick={HandleClose} className='hover:text-blue-500'>Contact Us</Link></li>
